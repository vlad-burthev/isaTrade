...
const CoffeeContext = React.createContext({
  coffee: [
    ...
    {
      id: 8,
      photo: "./img/catalog/coffee/str.jpg",
      name: "Зернова кава Strong",
      sort: "Купаж арабіки та робусти",
      roast:
        "Ідеальна для заварювання в туркі та приготування на автоматичних кавомашинах",
      strength: 5, // міцність
      description: "Має  насичений смак і стійкий  присмак.",
      taste: "Відчуваються легкі  нотки шоколаду та тірамісу",
      price: 30,
    },
  ],
